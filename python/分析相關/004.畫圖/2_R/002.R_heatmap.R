# References : https://github.com/LeahBriscoe/AdvancedHeatmapTutorial/tree/master
...
test <- read.csv("./python/分析相關/003.畫圖/2_R/SampleAnnotatedHeatmapDataNorm.csv",row.names = 1)
...
#pdf(file="./python/分析相關/003.畫圖/2_R/AnnotatedHeatmap.pdf")
#par(cex.main=0.8, mar = c(1, 1, 1, 1))
heatmap.plus(input, col=bluered(20),cexRow=1,cexCol=0.2, margins = c(20,13), main="Title",
